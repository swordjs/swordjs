import require$$0$1 from 'node:punycode'
...
(function (module) {
  ...
  function parseIPv6(input) {
	  ...
	  input = Array.from(input, (c) => { return c.codePointAt(0) })
  ...
  function URLStateMachine(input, base, encodingOverride, url, stateOverride) {
	  ...
	  this.input = Array.from(this.input, (c) => { return c.codePointAt(0) })
...
const URLSearchParams$1 = /* @__PURE__ */(function () {
  function URLSearchParams(constructorArgs, ref) {
    let doNotStripQMark = ref.doNotStripQMark; if (doNotStripQMark === void 0)
